...
const UzitoZaidiWiki27 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaUzitoZaidiWeek27/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataUzitoZaidiWeek27/');
...
//FOR  APIS
const { datas:TaarifaZaUzitoZaidi } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUzitoZaidiWeek27/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:UzitoZaidi, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/UzitoZaidiWeek27/');
...
export default UzitoZaidiWiki27;

...
const UzitoZaidiWiki29 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaUzitoZaidiWeek29/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataUzitoZaidiWeek29/');
...
//FOR  APIS
const { datas:TaarifaZaUzitoZaidi } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUzitoZaidiWeek29/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:UzitoZaidi, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/UzitoZaidiWeek29/');
...
export default UzitoZaidiWiki29;

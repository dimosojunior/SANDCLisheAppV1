...
import UzitoZaidiWeeksRenderedScreen from '../Screens/UzitoZaidiWeeksRenderedScreen';


const UzitoZaidiHomeScreen = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaUzitoZaidiWeek1/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataUzitoZaidiWeek1/');
...
//FOR  APIS
const { datas:TaarifaZaUzitoZaidi } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUzitoZaidiWeek1/');
...
// const [UzitoZaidi, setWajawazito] = useState([
//   {
//     Time:'BREAKFAST',
//     Description:'Description 1',
...
//     ]);
 ...
 //FOR  APIS
const { datas:UzitoZaidi, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/UzitoZaidiWeek1/');
  ...
  const TaarifaZaUzitoZaidiCard = ({data}) => {
    return (
      <TouchableOpacity
...
{UzitoZaidi && UzitoZaidi.length > 0 ? (
                ...
                style={globalStyles.MainContainerListFilterContainer}
                 >
                  ...
                  {UzitoZaidi.map(data => {
                    return <UzitoZaidiCard data={data} key={data.id} />;
                  })}
                </View>
...
{/*TAARIFA ZA UJAUZITO*/}
 ...
 {TaarifaZaUzitoZaidi && TaarifaZaUzitoZaidi.length > 0 ? (
          <View
        style={globalStyles.MainContainerNdogo}
          >
          <View
          ...
          style={globalStyles.MainContainerListFilterContainer}
           >
            ...
            {TaarifaZaUzitoZaidi.map(data => {
              return <TaarifaZaUzitoZaidiCard data={data} key={data.id} />;
            })}
          </View>
...
export default UzitoZaidiHomeScreen;

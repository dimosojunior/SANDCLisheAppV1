...
const UzitoZaidiWiki33 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaUzitoZaidiWeek33/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataUzitoZaidiWeek33/');
...
//FOR  APIS
const { datas:TaarifaZaUzitoZaidi } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUzitoZaidiWeek33/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:UzitoZaidi, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/UzitoZaidiWeek33/');
...
export default UzitoZaidiWiki33;

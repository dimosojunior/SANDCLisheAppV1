...
const UzitoZaidiWiki11 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaUzitoZaidiWeek11/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataUzitoZaidiWeek11/');
...
//FOR  APIS
const { datas:TaarifaZaUzitoZaidi } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUzitoZaidiWeek11/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:UzitoZaidi, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/UzitoZaidiWeek11/');
...
export default UzitoZaidiWiki11;

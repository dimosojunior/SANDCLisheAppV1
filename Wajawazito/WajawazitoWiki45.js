...
const WajawazitoWiki45 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaWajawazitoWeek45/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataWajawazitoWeek45/');
...
//FOR  APIS
const { datas:TaarifaZaUjauzito } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUjauzitoWeek45/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Wajawazito, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/WajawazitoWeek45/');
...
export default WajawazitoWiki45;

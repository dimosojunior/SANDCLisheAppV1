...
const WajawazitoWiki9 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaWajawazitoWeek9/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataWajawazitoWeek9/');
...
//FOR  APIS
const { datas:TaarifaZaUjauzito } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUjauzitoWeek9/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Wajawazito, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/WajawazitoWeek9/');
...
export default WajawazitoWiki9;

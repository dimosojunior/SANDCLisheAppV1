...
const WajawazitoWiki26 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaWajawazitoWeek26/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataWajawazitoWeek26/');
...
//FOR  APIS
const { datas:TaarifaZaUjauzito } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUjauzitoWeek26/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Wajawazito, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/WajawazitoWeek26/');
...
export default WajawazitoWiki26;

...
const WajawazitoWiki20 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaWajawazitoWeek20/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataWajawazitoWeek20/');
...
//FOR  APIS
const { datas:TaarifaZaUjauzito } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaUjauzitoWeek20/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Wajawazito, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/WajawazitoWeek20/');
...
export default WajawazitoWiki20;

...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaWatotoWeek32/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataWatotoWeek32/');
...
//FOR  APIS
const { datas:TaarifaZaWatoto } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaWatotoWeek32/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Watoto, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/WatotoWeek32/');

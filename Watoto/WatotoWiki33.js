...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaWatotoWeek33/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataWatotoWeek33/');
...
//FOR  APIS
const { datas:TaarifaZaWatoto } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaWatotoWeek33/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Watoto, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/WatotoWeek33/');

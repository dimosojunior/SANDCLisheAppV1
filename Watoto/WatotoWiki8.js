...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaWatotoWeek8/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataWatotoWeek8/');
...
//FOR  APIS
const { datas:TaarifaZaWatoto } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaWatotoWeek8/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Watoto, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/WatotoWeek8/');

...
const KisukariWiki23 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaKisukariWeek23/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataKisukariWeek23/');
...
//FOR  APIS
const { datas:TaarifaZaKisukari } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaKisukariWeek23/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Kisukari, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/KisukariWeek23/');

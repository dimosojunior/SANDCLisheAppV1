...
const KisukariWiki32 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaKisukariWeek32/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataKisukariWeek32/');
...
//FOR  APIS
const { datas:TaarifaZaKisukari } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaKisukariWeek32/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Kisukari, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/KisukariWeek32/');

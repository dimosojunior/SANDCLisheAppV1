...
const KisukariWiki26 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaKisukariWeek26/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataKisukariWeek26/');
...
//FOR  APIS
const { datas:TaarifaZaKisukari } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaKisukariWeek26/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Kisukari, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/KisukariWeek26/');

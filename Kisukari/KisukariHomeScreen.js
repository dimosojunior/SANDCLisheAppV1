...
import KisukariWeeksRenderedScreen from '../Screens/KisukariWeeksRenderedScreen';


const KisukariHomeScreen = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaKisukariWeek1/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataKisukariWeek1/');
...
//FOR  APIS
const { datas:TaarifaZaKisukari } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaKisukariWeek1/');
...
// const [Kisukari, setWajawazito] = useState([
//   {
//     Time:'BREAKFAST',
//     Description:'Description 1',
...
//     ]);
 ...
 //FOR  APIS
const { datas:Kisukari, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/KisukariWeek1/');
  ...
  const TaarifaZaKisukariCard = ({data}) => {
    return (
      <TouchableOpacity
...
{Kisukari && Kisukari.length > 0 ? (
                ...
                style={globalStyles.MainContainerListFilterContainer}
                 >
                  ...
                  {Kisukari.map(data => {
                    return <KisukariCard data={data} key={data.id} />;
                  })}
                </View>
...
{/*TAARIFA ZA UJAUZITO*/}
 ...
 {TaarifaZaKisukari && TaarifaZaKisukari.length > 0 ? (
          <View
        style={globalStyles.MainContainerNdogo}
          >
          <View
          ...
          style={globalStyles.MainContainerListFilterContainer}
           >
            ...
            {TaarifaZaKisukari.map(data => {
              return <TaarifaZaKisukariCard data={data} key={data.id} />;
            })}
          </View>
...
export default KisukariHomeScreen;

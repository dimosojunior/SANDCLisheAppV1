...
const KisukariWiki40 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaKisukariWeek40/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataKisukariWeek40/');
...
//FOR  APIS
const { datas:TaarifaZaKisukari } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaKisukariWeek40/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Kisukari, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/KisukariWeek40/');

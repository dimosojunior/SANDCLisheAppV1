...
const FamiliaWiki40 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaFamiliaWeek40/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataFamiliaWeek40/');
...
//FOR  APIS
const { datas:TaarifaZaFamilia } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaFamiliaWeek40/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Familia, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/FamiliaWeek40/');

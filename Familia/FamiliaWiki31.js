...
const FamiliaWiki31 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaFamiliaWeek31/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataFamiliaWeek31/');
...
//FOR  APIS
const { datas:TaarifaZaFamilia } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaFamiliaWeek31/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Familia, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/FamiliaWeek31/');

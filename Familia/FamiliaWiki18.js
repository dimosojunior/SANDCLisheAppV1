...
const FamiliaWiki18 = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaFamiliaWeek18/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataFamiliaWeek18/');
...
//FOR  APIS
const { datas:TaarifaZaFamilia } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaFamiliaWeek18/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Familia, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/FamiliaWeek18/');

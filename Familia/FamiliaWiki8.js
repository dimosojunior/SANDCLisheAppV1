...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaFamiliaWeek8/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataFamiliaWeek8/');
...
//FOR  APIS
const { datas:TaarifaZaFamilia } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaFamiliaWeek8/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Familia, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/FamiliaWeek8/');

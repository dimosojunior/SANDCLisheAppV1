...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaHivWeek24/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataHivWeek24/');
...
//FOR  APIS
const { datas:TaarifaZaHiv } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaHivWeek24/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Hiv, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/HivWeek24/');

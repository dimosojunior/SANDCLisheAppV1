...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaHivWeek9/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataHivWeek9/');
...
//FOR  APIS
const { datas:TaarifaZaHiv } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaHivWeek9/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Hiv, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/HivWeek9/');

...
import HivWeeksRenderedScreen from '../Screens/HivWeeksRenderedScreen';


const HivHomeScreen = ({navigation}) => {
...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaHivWeek1/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataHivWeek1/');
...
//FOR  APIS
const { datas:TaarifaZaHiv } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaHivWeek1/');
...
// const [Hiv, setWajawazito] = useState([
//   {
//     Time:'BREAKFAST',
//     Description:'Description 1',
...
//     ]);
 ...
 //FOR  APIS
const { datas:Hiv, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/HivWeek1/');
...
{Hiv && Hiv.length > 0 ? (
                ...
                style={globalStyles.MainContainerListFilterContainer}
                 >
                  ...
                  {Hiv.map(data => {
                    return <HivCard data={data} key={data.id} />;
                  })}
                </View>
...
{/*TAARIFA ZA UJAUZITO*/}
 ...
 {TaarifaZaHiv && TaarifaZaHiv.length > 0 ? (
          <View
        style={globalStyles.MainContainerNdogo}
          >
          <View
          ...
          style={globalStyles.MainContainerListFilterContainer}
           >
            ...
            {TaarifaZaHiv.map(data => {
              return <TaarifaZaHivCard data={data} key={data.id} />;
            })}
          </View>

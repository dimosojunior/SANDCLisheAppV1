...
//     ]);
 ...
 //FOR  APIS
const { datas:JeWajua } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/JeWajuaHivWeek15/');
...
//FOR  APIS
const { datas:MatatizoUnayowezaKupata } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/MatatizoUnayowezaKupataHivWeek15/');
...
//FOR  APIS
const { datas:TaarifaZaHiv } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/TaarifaZaHivWeek15/');
...
//     ]);
 ...
 //FOR  APIS
const { datas:Hiv, isPending, error } = useFetch('https://lisheapisapp.pythonanywhere.com/Lishe/HivWeek15/');
